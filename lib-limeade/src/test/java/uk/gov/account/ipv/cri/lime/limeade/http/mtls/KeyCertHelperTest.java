package uk.gov.account.ipv.cri.lime.limeade.http.mtls;

import org.junit.jupiter.api.Test;
import org.junit.jupiter.api.extension.ExtendWith;
import org.mockito.junit.jupiter.MockitoExtension;
import uk.gov.account.ipv.cri.lime.limeade.service.http.mtls.KeyCertHelper;
import uk.gov.account.ipv.cri.lime.limeade.service.http.mtls.Thumbprints;
                ...
                () ->
                        key.set(
                                KeyCertHelper.makeThumbprint(
                                        KeyCertHelper.getDecodedX509Certificate(TEST_ROOT_CRT))));
        assertNotNull(key.get());
    }
}
